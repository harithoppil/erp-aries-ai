    ...
    <div className="flex flex-col h-[calc(100vh-5.5rem)]">
      <div className="flex-1 min-h-0 overflow-auto pr-2">
        <div className="space-y-4 pb-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#0f172a]">Departments</h2>
            <p className="text-sm text-[#64748b] mt-1">Manage company departments</p>
          </div>
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center justify-center py-16 text-[#94a3b8]">
            ...
            <p className="text-lg font-medium">Departments coming soon</p>
