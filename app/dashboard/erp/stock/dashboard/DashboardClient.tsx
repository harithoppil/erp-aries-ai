...
const STOCK_LINKS = [
  ...
  { label: 'Item Group', icon: Layers },
  { label: 'Item Attribute', icon: Tag },
  { label: 'Brand', icon: Paintbrush },
  { label: 'UOM', icon: Ruler },
  { label: 'Warehouse', icon: Warehouse },
  { label: 'Stock Entry', icon: ArrowRightLeft },
  { label: 'Delivery Note', icon: Truck },
  { label: 'Purchase Receipt', icon: FileText },
  { label: 'Pick List', icon: ClipboardCheck },
  { label: 'Stock Reconciliation', icon: MapPin },
  { label: 'Landed Cost Voucher', icon: Hash },
  { label: 'Serial No', icon: Hash },
  { label: 'Batch', icon: Container },
  { label: 'Packing Slip', icon: Boxes },
];

// ── KPI Data ───────────────────────────────────────────────────────────────

const KPI_CONFIG = [
  { key: 'items' as const, label: 'Items', icon: Package, bg: 'bg-blue-50 text-blue-600' },
  { key: 'warehouses' as const, label: 'Warehouses', icon: Warehouse, bg: 'bg-emerald-50 text-emerald-600' },
  { key: 'stockEntries' as const, label: 'Stock Entries', icon: ArrowRightLeft, bg: 'bg-amber-50 text-amber-600' },
  { key: 'deliveryNotes' as const, label: 'Delivery Notes', icon: Truck, bg: 'bg-purple-50 text-purple-600' },
];
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <p className="text-sm text-[#64748b] max-w-md">
        Once you create items, warehouses, or stock entries, your stock
  ...
  return (
    <Card className="rounded-2xl border-gray-100 shadow-sm">
      <CardHeader className="pb-2">
        ...
        <p className="text-xs text-[#64748b]">Monthly stock entry creation over the past 12 months</p>
      </CardHeader>
      <CardContent>
