...
import DashboardClient from '@/app/dashboard/erp/accounting/dashboard/DashboardClient';

export const dynamic = 'force-dynamic';

export default async function AccountingDashboardPage() {
  try {
    const [accounts, journalEntries, paymentEntries, fiscalYears] =
      await Promise.all([
    ...
    const chartData = await getMonthlyData('journalEntry');

    const kpis = { accounts, journalEntries, paymentEntries, fiscalYears };
