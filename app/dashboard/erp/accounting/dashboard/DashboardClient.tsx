...
const ACCOUNTING_LINKS = [
  { label: 'Account', icon: BookOpen },
  { label: 'Journal Entry', icon: FileText },
  { label: 'Payment Entry', icon: CreditCard },
  { label: 'Payment Order', icon: Receipt },
  { label: 'Fiscal Year', icon: Calendar },
  { label: 'Company', icon: Building2 },
  { label: 'Cost Center', icon: Target },
  { label: 'Budget', icon: Banknote },
  { label: 'Bank', icon: Landmark },
  { label: 'Bank Account', icon: Landmark },
  { label: 'Sales Tax Template', icon: Receipt },
  { label: 'Purchase Tax Template', icon: Receipt },
  { label: 'Currency', icon: Globe },
  { label: 'Period Closing Voucher', icon: FileCheck },
...
const KPI_CONFIG = [
  { key: 'accounts' as const, label: 'Accounts', icon: BookOpen, bg: 'bg-blue-50 text-blue-600' },
  { key: 'journalEntries' as const, label: 'Journal Entries', icon: FileText, bg: 'bg-emerald-50 text-emerald-600' },
  { key: 'paymentEntries' as const, label: 'Payment Entries', icon: CreditCard, bg: 'bg-amber-50 text-amber-600' },
  { key: 'fiscalYears' as const, label: 'Fiscal Years', icon: Calendar, bg: 'bg-purple-50 text-purple-600' },
];
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <p className="text-sm text-[#64748b] max-w-md">
        Once you create accounts, journal entries, or payment entries, your
        accounting dashboard will show KPIs and trends here.
      </p>
    </div>
  );
}
  ...
  return (
    <Card className="rounded-2xl border-gray-100 shadow-sm">
      <CardHeader className="pb-2">
        ...
        <p className="text-xs text-[#64748b]">Monthly journal entry creation over the past 12 months</p>
      </CardHeader>
      <CardContent>
