      ...
      <div className="flex-1 min-h-0 overflow-auto pr-2"><div className="space-y-4 pb-4">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex gap-2">
            <ExportButton data={filtered.map(t => ({ name: t.name, subject: t.subject, status: t.status, priority: t.priority, project: t.project, progress: t.progress }))} filename="tasks" />
