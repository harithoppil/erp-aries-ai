...
const PROJECTS_LINKS = [
  ...
  { label: 'Project Template', icon: LayoutTemplate },
  { label: 'Task', icon: CheckSquare },
  { label: 'Timesheet', icon: Clock },
  { label: 'Activity Type', icon: Activity },
  { label: 'Activity Cost', icon: DollarSign },
];

// ── KPI Data ───────────────────────────────────────────────────────────────

const KPI_CONFIG = [
  { key: 'projects' as const, label: 'Projects', icon: FolderKanban, bg: 'bg-blue-50 text-blue-600' },
  { key: 'tasks' as const, label: 'Tasks', icon: CheckSquare, bg: 'bg-emerald-50 text-emerald-600' },
  { key: 'timesheets' as const, label: 'Timesheets', icon: Clock, bg: 'bg-amber-50 text-amber-600' },
  { key: 'activityTypes' as const, label: 'Activity Types', icon: Activity, bg: 'bg-purple-50 text-purple-600' },
];
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <p className="text-sm text-[#64748b] max-w-md">
        Once you create projects, tasks, or timesheets, your projects dashboard
        will show KPIs and trends here.
      </p>
    </div>
  );
}
  ...
  return (
    <Card className="rounded-2xl border-gray-100 shadow-sm">
      <CardHeader className="pb-2">
        ...
        <p className="text-xs text-[#64748b]">Monthly project creation over the past 12 months</p>
      </CardHeader>
      <CardContent>
