...
const BUYING_LINKS = [
  ...
  { label: 'Supplier Group', icon: Users },
  { label: 'Request for Quotation', icon: Mail },
  { label: 'Supplier Quotation', icon: Quote },
  { label: 'Purchase Order', icon: ShoppingCart },
  { label: 'Purchase Invoice', icon: FileText },
  { label: 'Material Request', icon: ClipboardList },
  { label: 'Purchase Receipt', icon: Package },
  { label: 'Incoterm', icon: Globe },
];

// ── KPI Data ───────────────────────────────────────────────────────────────

const KPI_CONFIG = [
  { key: 'suppliers' as const, label: 'Suppliers', icon: Truck, bg: 'bg-blue-50 text-blue-600' },
  { key: 'purchaseOrders' as const, label: 'Purchase Orders', icon: ShoppingCart, bg: 'bg-emerald-50 text-emerald-600' },
  { key: 'purchaseInvoices' as const, label: 'Purchase Invoices', icon: FileText, bg: 'bg-amber-50 text-amber-600' },
  { key: 'materialRequests' as const, label: 'Material Requests', icon: ClipboardList, bg: 'bg-purple-50 text-purple-600' },
];
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <p className="text-sm text-[#64748b] max-w-md">
        Once you create suppliers, purchase orders, or material requests, your
        buying dashboard will show KPIs and trends here.
      </p>
    </div>
  );
}
  ...
  return (
    <Card className="rounded-2xl border-gray-100 shadow-sm">
      <CardHeader className="pb-2">
        ...
        <p className="text-xs text-[#64748b]">Monthly purchase order creation over the past 12 months</p>
      </CardHeader>
      <CardContent>
