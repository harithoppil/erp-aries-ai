...
const QUALITY_LINKS = [
  ...
  { label: 'Quality Goal', icon: Target },
  { label: 'Quality Procedure', icon: ListChecks },
  { label: 'Quality Review', icon: Eye },
  { label: 'Quality Action', icon: Zap },
  { label: 'Non Conformance', icon: AlertTriangle },
  { label: 'Quality Feedback', icon: MessageSquare },
  { label: 'Quality Meeting', icon: Users },
];

// ── KPI Data ───────────────────────────────────────────────────────────────

const KPI_CONFIG = [
  { key: 'qualityInspections' as const, label: 'Inspections', icon: ClipboardCheck, bg: 'bg-blue-50 text-blue-600' },
  { key: 'qualityGoals' as const, label: 'Quality Goals', icon: Target, bg: 'bg-emerald-50 text-emerald-600' },
  { key: 'qualityReviews' as const, label: 'Quality Reviews', icon: Eye, bg: 'bg-amber-50 text-amber-600' },
  { key: 'nonConformances' as const, label: 'Non Conformances', icon: AlertTriangle, bg: 'bg-red-50 text-red-600' },
];
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <p className="text-sm text-[#64748b] max-w-md">
        Once you create quality inspections, goals, or reviews, your quality
  ...
  return (
    <Card className="rounded-2xl border-gray-100 shadow-sm">
      <CardHeader className="pb-2">
        ...
        <p className="text-xs text-[#64748b]">Monthly quality inspection creation over the past 12 months</p>
      </CardHeader>
      <CardContent>
