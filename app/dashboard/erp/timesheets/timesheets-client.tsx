...
import { listTimesheets, createTimesheet, type ClientSafeTimesheet } from "@/app/dashboard/erp/timesheets/actions";
    ...
    registerActions(
      [
        defineAction({
          ...
          description: "Open and fill the create timesheet form with the provided details. Opens dialog and fills all fields in one shot.",
          parameters: {
            type: "object",
            required: ["date", "hours"],
            properties: {
        ...
        defineAction({
          name: "set_timesheet_search",
          description: "Filter the timesheet list by search term",
          parameters: {
            type: "object",
            required: ["term"],
            properties: {
