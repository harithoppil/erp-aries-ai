      ...
      <div className="flex-1 min-h-0 overflow-auto pr-2">
        <div className="space-y-4 pb-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h2 className="text-2xl font-bold text-[#0f172a]">Taxes</h2>
              <p className="text-sm text-[#64748b] mt-1">Tax configuration and management</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12">
            <div className="flex flex-col items-center justify-center text-[#94a3b8]">
              ...
              <p className="text-lg font-medium text-[#0f172a]">Tax configuration coming soon</p>
              <p className="text-sm mt-1">Tax templates, rates, and categories will be available here.</p>
            </div>
          </div>
        </div>
      </div>
