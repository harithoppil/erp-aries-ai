...
const MANUFACTURING_LINKS = [
  { label: 'BOM', icon: Layers },
  { label: 'Work Order', icon: Factory },
  { label: 'Production Plan', icon: CalendarCheck },
  { label: 'Job Card', icon: Wrench },
  { label: 'Workstation', icon: Building2 },
  { label: 'Operation', icon: Cog },
  { label: 'Routing', icon: Route },
  { label: 'Downtime Entry', icon: Clock },
  { label: 'Plant Floor', icon: Cpu },
];

// ── KPI Data ───────────────────────────────────────────────────────────────

const KPI_CONFIG = [
  { key: 'bOM' as const, label: 'BOM', icon: Layers, bg: 'bg-blue-50 text-blue-600' },
  { key: 'workOrders' as const, label: 'Work Orders', icon: Factory, bg: 'bg-emerald-50 text-emerald-600' },
  { key: 'jobCards' as const, label: 'Job Cards', icon: Wrench, bg: 'bg-amber-50 text-amber-600' },
  { key: 'productionPlans' as const, label: 'Production Plans', icon: CalendarCheck, bg: 'bg-purple-50 text-purple-600' },
];
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <p className="text-sm text-[#64748b] max-w-md">
        Once you create BOMs, work orders, or job cards, your manufacturing
  ...
  return (
    <Card className="rounded-2xl border-gray-100 shadow-sm">
      <CardHeader className="pb-2">
        ...
        <p className="text-xs text-[#64748b]">Monthly work order creation over the past 12 months</p>
      </CardHeader>
      <CardContent>
