...
import { listSalesOrders, createSalesOrder, type ClientSafeSalesOrder } from "@/app/dashboard/erp/sales-orders/actions";
    ...
    registerActions(
      [
        defineAction({
          ...
          description: "Open and fill the create sales order form with the provided details. Opens dialog and fills all fields in one shot.",
          parameters: {
            type: "object",
        ...
        defineAction({
          name: "set_sales_order_search",
          description: "Filter the sales order list by search term",
          parameters: {
            type: "object",
            required: ["term"],
            properties: {
